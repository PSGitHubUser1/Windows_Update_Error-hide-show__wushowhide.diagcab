#Ulitily file for Windows Hide Unhide Updates.
# Function to search updates
function Pop-Msg {
...
#Function to Search the Windows Update

function CollectWindowsUpdate
{
    $session = new-object -ComObject Microsoft.Update.Session
	$searcher = $session.CreateUpdateSearcher()
	$result = $searcher.Search("IsInstalled=0")  #"IsInstalled=0" finds updates that are not installed on the destination computer.
	$Updatelist = $result.Updates | select Title , IsHidden, KBArticleIDs
	$count = $result.Updates
	$Global:Updatelist = $Updatelist
	$Global:result = $result
	$Global:count = $count
	return $Global:Updatelist, $Global:result , $Global:count
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUfKVMlTucgk7Dr766pCwYT4KE
# p7agghWCMIIEwzCCA6ugAwIBAgITMwAAAHGzLoprgqofTgAAAAAAcTANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFCbU
# qDAmHf8Y1UOVLU3IIn50KTWgMGQGCisGAQQBgjcCAQwxVjBUoDqAOABXAHUAUwBo
# AG8AdwBIAGkAZABlAF8AQwBMAF8AVwBpAG4AZABvAHcAcwBfAEgAVQAuAHAAcwAx
# oRaAFGh0dHA6Ly9taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAHI68MKS
# bBZOPy3101Jc5KvJHCgzE74xTtVXclAffDLm0hkjY48MFIvDjhslBNONaIpqr8oe
# nf48PQLfrDxUz8kYPMKhIxCQx4BIoOZ8hmJAnpognx+VR6iKEpj5OQyfePg2INYA
# EmRkrc0yU9+hABIdGSX0mpGvEkrZnHcRxw/cb6k2AVVEes9Fhj3bLvddiEFdq8pE
# xgtAbId4UHSmIArWTX29/xoZSRJ0mh7tyyTrwNG1nrlqMsU3OpveUW0Ge4btUQJk
# Am9+1FEjcKsYZ3tb1cyMV2JV8h6hJtwfSBeVQW6FsS1mfCsIA7S8JFzZK+Gf7H1F
# D4i04uIXyKU/Y/ihggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzEL
# MAkGA1UEBhMCVVMxEzARBgNVBAgTCldhc2hpbmd0b24xEDAOBgNVBAcTB1JlZG1v
# bmQxHjAcBgNVBAoTFU1pY3Jvc29mdCBDb3Jwb3JhdGlvbjEhMB8GA1UEAxMYTWlj
# cm9zb2Z0IFRpbWUtU3RhbXAgUENBAhMzAAAAcbMuimuCqh9OAAAAAABxMAkGBSsO
# AwIaBQCgXTAYBgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEP
# Fw0xNTA2MTUyMDA2NTdaMCMGCSqGSIb3DQEJBDEWBBRhkW9Eom7sqTxOrR2paKVP
# Mzo6PTANBgkqhkiG9w0BAQUFAASCAQBFEEzN6hIHyEcSCRHGle3mgXeLUqGD7I2L
# yOLMH/b4qF2K5kDRQ4neRl2WaXCDolvJX/w6EzHSI+QK7UaRTHkYHAWsK8ep6791
# AJS9MDcN6OG5YfI1wrcvcaVT/3XuqrCXjcQCFiuF+P5N/FwyAaXaupfG6GSNWd0T
# o2qugllEP2LJOJ16zamqh+S8Ok8HDU4juGm6NLVZsZrmkS3Xl1EaRbn19ENnd88d
# fhYajhbT2FzPeaMwENY4VM6CVnqNgIR1qRlLaCUfHHK8/C1r9Zcp2gpKax4jOGnz
# qLbqWvVn35r1LRc7gURVUZYpBIjWDT4q5ZnijIGmKSl2tCLBFSdB
