...
Import-LocalizedData -BindingVariable string_RCHide -FileName RC_HideUpdates

$Global:RootCauseId = "RC_HideUpdates"
$Global:RootCauseDetected = $true

ForEach ($i In $Global:Updatelist)
{
	if($i.IsHidden -eq $false)
	{
		$Global:hideitemNames += @{"Name" = ($i.Title); "Value" = ($i.Title); "Description" = ""; "ExtensionPoint" = ""}
	}
}
if($Global:hideitemNames -ne $null)
{
	$Global:items = Get-DiagInput -Id "HideChoice" -Choice $Global:hideitemNames
	ForEach ($item In $Global:items)
	{
		$Global:SelectedUpdate += $item + ";"
		Update-DiagRootCause -id $Global:RootCauseId -iid $item -Detected $Global:RootCauseDetected -Parameter @{"VF_Value" = $item}
	}
}
else
{
	$noupdate= $string_RCHide.ID_RC_HIDE
	Get-DiagInput -id IT_NoUpdate -Parameter @{"Noupdate" = "$noupdate"}
}

# SIG # Begin signature block
# MIIaxQYJKoZIhvcNAQcCoIIatjCCGrICAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUHj7az+0MpQYOljJtI2r+o8wi
# acqgghWCMIIEwzCCA6ugAwIBAgITMwAAAHGzLoprgqofTgAAAAAAcTANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFBd/
# LQqJV3QR+PSAQ4vlf+1JR8OhMGYGCisGAQQBgjcCAQwxWDBWoDyAOgBXAHUAUwBo
# AG8AdwBIAGkAZABlAF8AUgBDAF8ASABpAGQAZQBVAHAAZABhAHQAZQBzAC4AcABz
# ADGhFoAUaHR0cDovL21pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEBBQAEggEAMqPo
# H8fDsGC35vtUQqF3B1j73n13VrnqSftb1m27WKrTUM+bF0oLfSg76LsVFXj2LuHo
# mD95nU6e+qD/IyxZbshLwe5mPCjBJIBhY6luTuTnUGEpD+6lX4ScCT0VjfONNm+K
# 6tVon9VhWB7qyIhjCDAHJMy7xrfYDV7R6aZRny3XJCjRPmxMvYJhcL5BV6wsx7L0
# as0PESI89jmpeqayb9eV+YRCE2Mvf4QBjUAXr+yek2FvmbVe55tL52wFd0l0oLBO
# mHVSvag/M6NdQwscqLZZbo4YUFYzUuvIy8HCD97kt+ucH+/S0gxZS69yxUozZ7sK
# uZRv2B+nX4E5eGVRfKGCAigwggIkBgkqhkiG9w0BCQYxggIVMIICEQIBATCBjjB3
# MQswCQYDVQQGEwJVUzETMBEGA1UECBMKV2FzaGluZ3RvbjEQMA4GA1UEBxMHUmVk
# bW9uZDEeMBwGA1UEChMVTWljcm9zb2Z0IENvcnBvcmF0aW9uMSEwHwYDVQQDExhN
# aWNyb3NvZnQgVGltZS1TdGFtcCBQQ0ECEzMAAABxsy6Ka4KqH04AAAAAAHEwCQYF
# Kw4DAhoFAKBdMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkF
# MQ8XDTE1MDYxNTIwMDY1N1owIwYJKoZIhvcNAQkEMRYEFJYqCnd5feAFRrTyDOza
# 97c7aRRUMA0GCSqGSIb3DQEBBQUABIIBAFdmho7L89fPMhekxCYPwHrLex4zD1ES
# rf3K+Zs/qnU4q+gwPdCKFOmmgmI2ow4QElZXgn8BGLsBwWVsR6AoPN/rLZUJka6j
# zUY4Fo01WEqCSQ8c1Fcd1p/9JpABpF+YOcW9YWum3wjRY1GpzCRDBbjm0HTRBV+C
# hnG2yldGmsDfXr27mRYF4zL0v1Ldmf4TLf+SEo1zeU0EbObDDDi4IHppiGujCHoN
# tkpqq38rOoReyueAtCMjZbXNp3nebDhcqTYpElTn6XL35n+n3t8XsUQEYde0pUpd
# phCZZ+CGZ+Ivdx1XbM7YrVHtMUUk350d8eSirQVMCYI6dwj9RACE02Q=
